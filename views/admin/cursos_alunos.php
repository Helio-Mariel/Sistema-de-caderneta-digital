...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4 mt-4">
            <h1 class="mt-4 mr-4">Listagem de Alunos</h1>
            ...
            <table id="" class="table table-striped table-bordered dataTable no-footer" cellspacing="0"
                ...
                <tbody>
                    <form action="admin_alunos" method="GET">
                        <tr role="row" class="odd">
                            <td class="sorting_1">
                                <div class="col-md-12">
                                    <!--    <label for="select1">Curso : </label> -->
                                    <select class="form-control" id="select1" name="" onchange="atualizarSelect2()">
                            ...
                            <td class="sorting_1">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="select2" name="" onchange="atualizarSelect2()">
                                        <option selected>Escolha...</option>
