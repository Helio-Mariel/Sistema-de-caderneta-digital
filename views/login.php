                        ...
                        <div class="card-body p-5 text-center">
                            <form action="login_aluno" method="POST">
                                <div class="mb-md-5 mt-md-4 pb-5">
                                    ...
                                    <p class="text-white-50 mb-5">Introduza nome de usúario e a sua Palavra-Passe!</p>
                                    <div class="form-outline form-white mb-5">
                                        <input type="text" id="username" class="form-control form-control-lg" placeholder="Utilizador" name="username" />
                                    </div>
                                    <div class="form-outline form-white mb-4">
                                        <input type="password" id="password" class="form-control form-control-lg" placeholder="Palavra-Passe" name="password" />
                                    </div>
