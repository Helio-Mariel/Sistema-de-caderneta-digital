                ...
                <thead>
                    <tr role="row">
                        <th style="background-color: rgb(0, 83, 132); color: white; font-size: 16px; width: 448.778px;"
                            tabindex="0" aria-controls="table1B" rowspan="1" colspan="1" aria-label="Disciplinas"
                            aria-sort="descending">
                            Disciplinas</th>
                        <th style="background-color: rgb(0, 83, 132); color: white; font-size: 16px; width: 489.778px;"
                            rowspan="1" colspan="1" aria-label="Curso">Curso</th>
                        <th style="background-color: rgb(0, 83, 132); color: white; font-size: 16px; width: 489.778px;"
                            rowspan="1" colspan="1" aria-label="Classe">Classe</th>
                        <th style="background-color: rgb(0, 83, 132); color: white; font-size: 16px; width: 489.778px;"
                            rowspan="1" colspan="1" aria-label="Turma">Turma</th>
                        <th style="background-color: rgb(0, 83, 132); color: white; font-size: 16px; width: 489.778px;"
                            rowspan="1" colspan="1" aria-label="Turma">Dia da Semana</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
